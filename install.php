...
function install_package(){
    ...
    $core->db->query("ALTER TABLE `{#}content_types` CHANGE `seo_keys` `seo_keys` VARCHAR(256) NULL DEFAULT NULL COMMENT 'Ключові слова'");
    $core->db->query("ALTER TABLE `{#}content_types` CHANGE `seo_desc` `seo_desc` VARCHAR(256) NULL DEFAULT NULL COMMENT 'Опис'");
